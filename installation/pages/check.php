...
if(preg_match('/microsoft-iis/i', strtolower($_SERVER["SERVER_SOFTWARE"]))){
    echo '<div class="ossn-installation-message ossn-installation-success">IIS</div>';
} else {
    echo '<div class="ossn-installation-message ossn-installation-fail">IIS REQUIRED</div>';
    $error[] = 'apache';
}
